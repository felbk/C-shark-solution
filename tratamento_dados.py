...
def calcula_total(document_id):
    ...
    #Agrupa as vendas por estabelecimento e por dia da semana retornando o valor total de cada dia da semana 

    ticket_diario = subset_empresa.groupby('date_time')['value'].agg(['sum'])

    return ticket_diario

#Função para prever o valor médio
